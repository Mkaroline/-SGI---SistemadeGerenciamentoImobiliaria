...
public static void pesquisarAgendamento(Scanner scanner) {
    ...
    String dataStr = scanner.nextLine();
    try {
        LocalDate dataPesquisa = new SimpleDateFormat("dd/MM/yyyy").parse(dataStr).toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
...
public static void listarAgendamentos(Scanner scanner, AgendaDAO agendaDAO) {
    try {
        ...
        LocalDate dataInicio = new SimpleDateFormat("dd/MM/yyyy").parse(dataInicioStr).toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
        
        System.out.print("Digite a data de fim (dd/MM/yyyy): ");
        String dataFimStr = scanner.nextLine();
        LocalDate dataFim = new SimpleDateFormat("dd/MM/yyyy").parse(dataFimStr).toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
